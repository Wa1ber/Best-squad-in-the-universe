...
txt_test2 = ('Выполните 30 приседаний за 45 секунд. Для этого нажмите кнопку "Начать делать приседания",/n'
'чтобы запустить счетчик приседаний.')
txt_test3 = ('Лягте на спину и замерьте пульс сначала з   а первые 15 секунд минуты, затем за последние 15 секунд.\n'
...
txt_hinttest2 = '0'
txt_hinttest3 = '0'
txt_starttest1 = 'Начать тест'
txt_starttest2 = 'Начать тест'
txt_starttest3 = 'Начать тест'
